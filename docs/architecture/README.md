...
| 7 | [The full sequence](./07-lifecycle-sequence.md) | Every exchange on one timeline — page load, calls, navigation, cancellation, teardown, and the one your app is never told about |
